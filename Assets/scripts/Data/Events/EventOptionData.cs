...
public class EventOptionData
{
    ...
    [Header("遗物系统")]
    public RelicData TargetRelic;                           // [NEW] 目标遗物 (用于 GainSpecificRelic)
    
    [Header("Lua脚本系统")]
    [Tooltip("Lua脚本路径 (相对于 Resources/Lua/Events/), 例如: 'train_event'")]
    public string LuaScriptPath;                            // [NEW] Lua脚本路径 (用于 LuaEffect)
