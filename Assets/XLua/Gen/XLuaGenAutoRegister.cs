...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(EffectType), EffectTypeWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Location), LocationWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(EffectFlag), EffectFlagWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(EventCode), EventCodeWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Reason), ReasonWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(EffectCode), EffectCodeWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Position), PositionWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(RuntimeCard), RuntimeCardWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(RuntimeUnit), RuntimeUnitWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Duel), DuelWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Effect), EffectWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(EventSystem), EventSystemWrap.__Register);
